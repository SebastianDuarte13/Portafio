...
function updateSlide() {
  slides.forEach((slide, index) => {
    ...
    dots.children[index].classList.toggle('active', index === currentIndex);
  });
}
...
// Eventos para los botones y la navegación automática
document.getElementById('prevButton').addEventListener('click', prevSlide);
document.getElementById('nextButton').addEventListener('click', nextSlide);
let intervalIdd = setInterval(nextSlide, 4000);

document.getElementById('sliderContainer').addEventListener('mouseenter', () => clearInterval(intervalIdd));
document.getElementById('sliderContainer').addEventListener('mouseleave', () => intervalIdd = setInterval(nextSlide, 4000));
