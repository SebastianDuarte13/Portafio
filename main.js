...
const proyectos = [
    { id: 1, titulo: "Proyecto 1", descripcion: "Este proyecto se enfonco en el desarrollo de plantillas css y volviendolas responsivas una y cada una con un menu intuitivo que permite navegar una y cada uda de estas pequeñas landing pages. Este proyecto se llevo acabo con mi colega samuel Ospina", imagen: "/img\landing-pages.png?height=400&width=600", link: "https://landingpagessamuel.netlify.app/", target: "_blank" },
    { id: 2, titulo: "Proyecto 2", descripcion: "En este proyecto se desarrolo un borrador para presentarle a un cliente de un catalogo de su propio restaurante para mostrar los servicios que ofrece, de manera web y movil siendo responsivo", imagen: "/img/catalogo-burger.png", link: "https://trabajo-reserreccion.vercel.app/" },
    { id: 3, titulo: "Proyecto 3", descripcion: "Este proyecto utiliza las habilidades de HTML, CSS y JavaScript para crear un pequeño formulario para registrar un heroe y almacenarlo en una base de datos con una imagen de dicho heroe", imagen: "/img/registro-heroes.png", link: "https://super-heros-five.vercel.app/" },
    { id: 4, titulo: "Proyecto 4", descripcion: "Para este proyecto se realizo una imitacion de la famosa app cuanto cuesta mi app, con la que se replico de la mejor manera utilizando web-componets para tener una mejor compilacion y desarrollo profesional.", imagen: "/img/cuantocuestamiapp.png", link: "https://trabajo-js-chi.vercel.app/" },
    { id: 5, titulo: "Proyecto 5", descripcion: "Confecciones Pepita, el mejor sistema de desarrollo, intuitivo y amigable a la hora de llevar el control administrativo de tus confecciones en una base de datos que te calcula todo de manera automatizada, ordenada y eficiente", imagen: "/img/confeccionespepita.png", link: "https://confecciones-pepita.vercel.app/" },
    { id: 6, titulo: "Proyecto 6", descripcion: "Cuando estamos en una empresa y quemeros llevar el control y tener roles y que cada uno de ellos tenga tareas especificas, le presentro mi proyecto full stack en el cual vinculamos Html, Css, JavaScript, MySQL, Java y Springboot y frameworks como nodeJs y arquitectura como la Hexagonal Para llevar a cabo una interfaz para administrativos y distintos roles que quieran agregrar para llevar el control empresarial y el orden en una empresa de entrada, salida y utilidad de productos en cualquier region, sucursal, etc...", imagen: "/img/prestService.png", link: "https://example.com/proyecto6" }
];
